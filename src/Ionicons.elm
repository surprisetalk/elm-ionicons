...
module Ionicons exposing (..)

-- DOCS ------------------------------------------------------------------------

{-| Learn more at [Ionicons](http://ionicons.com/).

    import Ionicons as Ion 
      exposing ( stylesheet
               , Icon(Spoon)
               , spoon
               )
...
Include Ionicons 2.0.1 in your Elm project.
    ...
    import Ionicons as Ion exposing (stylesheet,Icon(..))
...
{-| 
    import Ionicons as Ion exposing (..)
